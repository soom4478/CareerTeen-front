...
export default function JoinCard2({ onNext, onBack }: StepCardProps) {
    return (
        <div className="w-full h-full absolute z-20 px-[5%] overflow-hidden flex items-center backdrop-blur-[3px]"
            ...
            <form className="bg-white w-full pt-[95px] px-[20px] pb-[40px] rounded-[12px] relative">
                ...
                <div className="flex flex-col gap-[10px] mb-[24px]">
                    ...
                    <input type="text" placeholder="예. 홍길동" className="w-full px-[20px] py-[17px] rounded-[8px] border border-[#CCC] bg-[#F0F0F0]"></input>
                </div>
                <div className="flex flex-col gap-[10px] mb-[30px]">
                    <p className="text-[18px] font-medium text-[#222]">나이</p>
                    <input type="text" placeholder="예. 20세" className="w-full px-[20px] py-[17px] rounded-[8px] border border-[#CCC] bg-[#F0F0F0]"></input>
                </div>
